...
#btn-clear { border: 1px solid #e94560; color: #e94560; }
#btn-clear:hover { background: #e9456022; }
...
.req-item.selected { background: #0f3460; border-left: 3px solid #e94560; }
...
<body>
<header>
  <span class="logo">MiniApp Backend — Request Log</span>
...
function pick(id){
  ...
  const sc=l.status?(l.status<400?'ok':'err'):'pend';
  const rb=JSON.parse(JSON.stringify(l.reqBody||{}));
